...
import type { getAnalytics } from '@/app/actions/analytics'
...
export function NexoraWorkspace({ initialLeads = [], initialMarketing, initialAnalytics }: { initialLeads?: WorkspaceLead[]; initialMarketing: Awaited<ReturnType<typeof listMarketingData>>; initialAnalytics: Awaited<ReturnType<typeof getAnalytics>> }) {
        ...
        <section className="min-w-0 flex-1">
          ...
          <div className="grid gap-6 p-5 lg:p-8 xl:grid-cols-[minmax(0,1fr)_360px]">
            <div className="min-w-0 space-y-6">
              ...
              {activeNav === 'Analytics' && <AnalyticsPanel initialData={initialAnalytics} />}
              {activeNav === 'Nexora AI' && <AIAgentPanel />}
              {activeNav !== 'Analytics' && <div className="grid gap-3 sm:grid-cols-3"><Metric label="Pipeline value" value="No data available yet" trend="" /><Metric label="Qualified leads" value="No data available yet" trend="" /><Metric label="Marketing ROI" value="No data available yet" trend="" /></div>}
